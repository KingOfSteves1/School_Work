...
#choose what action base core of game
def sim():
    os.system('cls')
    global food
...
#raise water level known as wlevel      
def wraise():
    global wlevel
...
#lower the water level also known as wlevel      
def wlower():
    global wlevel
...
#You are disposing waste into the ocean      
def disposewaste():
    global wiocean
...
#Shooting a nuke that costs 6 mil       
def nuke():
    global money
